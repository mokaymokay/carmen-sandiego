...
-- We're booking the first flight out: maybe we've actually got a chance to catch
-- her this time. There are only two cities she could be flying to in the country.
...
-- speak; go find a city whose name is like the one we were headed to, but doesn't
-- end the same. Find out the city, and do another search for what country it's in.
-- Hurry!
...
-- We're close! Our South American agent says she just got a taxi at the airport,
-- and is headed towards the capital! Look up the country's capital, and get there
-- pronto! Send us the name of where you're headed and we'll follow right behind you!
...
-- and she beat us to the boarding gates. We have one chance to catch her, we just
-- have to know where she's heading and beat her to the landing dock.
-- Lucky for us, she's getting cocky. She left us a note, and I'm sure she thinks
-- she's very clever, but if we can crack it, we can finally put her where she belongs
-- – behind bars.
--
